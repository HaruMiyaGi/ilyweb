...
export default function LinksUpdateForm(props) {
  ...
  const [linksRecord, setLinksRecord] = React.useState(linksModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getLinks.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getLinks
        : linksModelProp;
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: updateLinks.replaceAll("__typename", ""),
            variables: {
              input: {
                id: linksRecord.id,
                ...modelFields,
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || linksModelProp)}
