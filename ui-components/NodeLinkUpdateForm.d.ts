...
export declare type NodeLinkUpdateFormProps = React.PropsWithChildren<{
    ...
    id?: string;
    nodeLink?: NodeLink;
    onSubmit?: (fields: NodeLinkUpdateFormInputValues) => NodeLinkUpdateFormInputValues;
    onSuccess?: (fields: NodeLinkUpdateFormInputValues) => void;
    onError?: (fields: NodeLinkUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: NodeLinkUpdateFormInputValues) => NodeLinkUpdateFormInputValues;
    onValidate?: NodeLinkUpdateFormValidationValues;
} & React.CSSProperties>;
export default function NodeLinkUpdateForm(props: NodeLinkUpdateFormProps): React.ReactElement;
